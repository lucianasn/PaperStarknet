...
token = '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'
...
def main():
    query = "starknet language:cairo"  # String de pesquisa
    ...
    for page in range(0, total_pages):
        ...
        if repositories:
            ...
            for repo in repositories:
                print(repo['name'])
                # retrieve commits of the repo
                #print(repo)
                #print('contributors: ')
                #print(repo['contributors_url'])
                #contributor_names = contributors.get_contributors_url(repo['contributors_url'], token)
                # do whatever you want with the contributors
                #print('')
